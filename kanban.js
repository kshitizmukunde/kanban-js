export default class Kanban{
    ...
    static updateTasks(taskId, updatedInformation) {
        const data = read();
...
// Kanban.deleteTask(24612);

// Kanban.insertTasks(0, "Record Kanban Lectures");

// console.log(Kanban.getTasks(1));

// console.log(Kanban.getAllTasks());

// Kanban.updateTasks(97522, {
//     columnId: 2,
